...
public class RideOfferAndRequestAdapter {
    ...
    public RideOfferOrRequest transform(final org.ishausa.transport.carpool.model.RideOffer rideOffer) {
        if (rideOffer == null) {
            return null;
        }
    ...
    public RideOfferOrRequest transform(final org.ishausa.transport.carpool.model.RideRequest rideRequest) {
        if (rideRequest == null) {
            return null;
        }
